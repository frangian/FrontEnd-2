...
function agregarNoticias (array){
    let html = "";
    array.forEach(e => {
        if(e.tipoNacional){
        html += `
...
// function noticiasNacionales(array){
//     array.forEach(e => {
//         if(e.tipoNacional){
//             console.log(e);
//             let noticiasArg = document.querySelectorAll("div");
//             noticiasArg.forEach(e => {
